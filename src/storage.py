...
def estimate_storage(model, weight_bits=8, activation_bits=8):
    """Estimate logical stored bytes, not the size of the fake-quantized PyTorch state_dict."""
    ...
    fp32_mb = (all_param_values + buffer_values) * 4 / 1024**2
    ...
    fp32_buffers_mb = buffer_values * 4 / 1024**2
